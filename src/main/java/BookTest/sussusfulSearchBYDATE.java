...
public class sussusfulSearchBYDATE {
    public sussusfulSearchBYDATE() {
    }
    ...
    public WebDriver function(){
       ...
       // driver.manage().window().maximize();
        ...
        driver.findElement(By.name("from")).sendKeys("2015-12-15");
        driver.findElement(By.name("to")).clear();
        driver.findElement(By.name("to")).sendKeys("2015-12-30");
